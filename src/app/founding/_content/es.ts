...
export const es: FoundingContent = {
  hero: {
    eyebrow: "Miembros Fundadores · Solicitudes abiertas",
    title: "La industria de la música de club, en un solo lugar",
  ...
  problem: {
    eyebrow: "El Problema",
    heading: "La industria de la música de club funciona con procesos y herramientas obsoletos",
    items: [
      {
        title: "No hay un directorio central",
      ...
      {
        title: "El mercado está controlado por unos pocos",
        body: "Las oportunidades quedan en manos de unos pocos actores. Los artistas emergentes, los promotores independientes y las nuevas salas no tienen una forma estructurada de darse a conocer y ganar credibilidad.",
      },
      {
        title: "No hay un camino de la búsqueda al acuerdo firmado",
        body: "Ninguna herramienta cubre el proceso de contratación completo — descubrimiento, propuesta, negociación, contrato, documentos y pago.",
      },
    ],
  },
  solution: {
  ...
  deepdives: [
    ...
    {
      headline: ["Gestiona tu roster.", "Cierra acuerdos."],
      body: "Un único panel para todo tu roster de artistas. Sigue cada acuerdo, calendario, contrato y pago de todos tus artistas — sin perder la cabeza.",
      points: [
  ...
  journey: {
    ...
    steps: [
      ...
      { title: "Confirmado", body: "Contrato firmado, pago confirmado. Trato hecho." },
    ],
  },
  touring: {
  ...
  cta: {
    ...
    pricingNote: "Unirse a TORA es gratis, y cada solicitud se revisa para mantener alta la calidad de la red. El plan Premium desbloquea las funciones más avanzadas — y los miembros fundadores (quienes se postulan antes del lanzamiento) lo reciben todo gratis durante sus tres primeros meses en la plataforma, sin ninguna obligación de continuar.",
  ...
  drawer: {
    ...
    items: {
      ...
      connect: {
        label: "Conecta",
        title: "Conecta y escribe",
        body: "Envía una solicitud de conexión y habla directamente. Negocia fechas y cachés, comparte documentos y mantén toda la conversación en un mismo hilo.",
      },
      offer: {
      ...
      contract: {
        ...
        body: "Genera, envía y firma contratos de contratación digitalmente — una firma electrónica real, dentro de la plataforma. Sin enviar PDFs de un lado a otro por correo.",
      },
      confirmed: {
        label: "Confirmado",
      ...
      travel: {
        ...
        title: "Agenda de viajes y alertas inteligentes",
        body: "Publica dónde estarás y cuándo. TORA te presenta al mercado adecuado y avisa por adelantado a salas y promotores cuando un artista relevante va a su ciudad.",
      },
      tour: {
        label: "Gira",
