...
export const fr: FoundingContent = {
  hero: {
    ...
    title: "L'industrie de la musique club, réunie au même endroit",
  ...
  problem: {
    eyebrow: "Le Problème",
    heading: "L'industrie de la musique club repose sur des processus et des outils dépassés",
    items: [
      {
  ...
  roles: [
    { body: "DJs, live acts et producteurs en quête de bookings à l'international et d'une représentation professionnelle." },
    { body: "Agences de talents gérant des rosters d'artistes, des tournées, des accords et des opportunités internationales." },
    { body: "Organisateurs d'événements qui bookent des artistes, construisent des line-ups et gèrent des partenariats avec des lieux à travers le monde." },
    { body: "Clubs et espaces événementiels qui veulent attirer les bons artistes et remplir leur calendrier." },
  ],
  deepdives: [
    {
      headline: ["Faites-vous découvrir.", "Bookez à l'international."],
      body: "Un profil vérifié qui vous représente professionnellement — genres, réseaux sociaux, disponibilités, press kit. Visible par les promoteurs et les lieux du monde entier, pas seulement dans votre ville.",
      points: [
    ...
    {
      headline: ["Trouvez le bon artiste.", "Composez le bon line-up."],
      body: "Recherchez des artistes par genre, localisation et disponibilité. Trouvez des lieux pour accueillir vos événements. Envoyez des propositions de booking directement — sans intermédiaire, sauf si vous en voulez un.",
      points: [
        "Filtres genre + localisation + disponibilité",
        "Propositions directes aux artistes ou aux agents",
        "Tour Kickstart : partagez les coûts de booking",
        "Matching basé sur le calendrier",
        "Confirmation du contrat et du paiement sur la plateforme",
      ],
    },
    {
  ...
  cta: {
    ...
    headingLine1: "Devenez",
    headingLine2: "Membre Fondateur",
    ...
    pricingNote: "Rejoindre TORA est gratuit, et chaque candidature est examinée pour préserver la qualité du réseau. L'offre Premium débloque les fonctionnalités les plus avancées — et les Membres Fondateurs (tous ceux qui candidatent avant le lancement) en profitent gratuitement pendant leurs trois premiers mois sur la plateforme, sans aucune obligation de continuer.",
  ...
  drawer: {
    ...
    items: {
      ...
      connect: {
        ...
        body: "Envoyez une demande de connexion, puis discutez directement. Négociez les dates et les cachets, partagez des documents et gardez toute la conversation dans un seul fil.",
      },
      offer: {
      ...
      contract: {
        ...
        body: "Générez, envoyez et signez des contrats de booking numériquement — une véritable signature électronique, directement sur la plateforme. Fini les allers-retours de PDF par e-mail.",
      },
      confirmed: {
        label: "Confirmé",
