            ...
            <div className="pt-32 pb-20 px-8 max-w-4xl mx-auto space-y-16">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-white/40 text-sm uppercase tracking-widest" style={{ fontFamily: 'var(--font-space-grotesk), sans-serif' }}>
                        Tools built for music professionals
                    </p>
                </div>
                    ...
                    {[
                        {
                            ...
                            desc: "Find professionals by role, city, genre, and availability. Discover who's nearby, who's touring, and who fits your next event."
                        },
                        {
                            ...
                            desc: "Share your available dates and find professionals with overlapping schedules. Artists meet promoters and venues in the right city at the right time."
                        },
                        {
                            title: "Tour Kickstarter",
                            ...
                            desc: "Plan multi-city tours by selecting a region and dates. Receive proposals from promoters and venues interested in booking you."
                        },
                        {
                            ...
                            desc: "Get notified when an artist you follow is touring near your city, or when a venue matches your availability."
                        },
                        {
                            ...
                            desc: "Send and receive booking offers with full deal management — fees, contracts, payments, and communication in one place."
                        },
                        {
                            title: "Messaging",
                            ...
                            desc: "Direct professional communication linked to your bookings and deals. Every conversation in context, nothing lost in email threads."
                        },
                        {
                            ...
                            desc: "Send contracts, track signatures, and manage payments — the full deal lifecycle from offer to final settlement, all in one place."
                        },
                        {
                            ...
                            desc: "Artist profiles with music, links, press kits, tech riders, and contracts — all in one place. Embed SoundCloud, Spotify, and RA directly."
                        },
                        {
                            ...
                            desc: "Full roster management for agents. Handle schedules, bookings, finances, and contracts for all your artists from one place."
                        },
                        {
                            ...
                            desc: "Manage multiple profiles under one account. Be an artist and an agent, or a promoter and a venue — switch roles seamlessly."
                        },
                    ].map((item) => (
                        <GlassCard key={item.title} className="border-white/5">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-infrared text-xs font-bold uppercase tracking-widest">{item.title}</span>
                            </div>
                            <p className="text-white/70 text-sm leading-relaxed mt-3">{item.desc}</p>
                        </GlassCard>
                    ))}
                </div>
