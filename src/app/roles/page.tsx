...
const roles = [
    {
        ...
        desc: "DJs, producers, and live performers. Share your availability, get discovered worldwide, build your own tours, and manage your bookings."
    },
    {
        title: "Promoters",
        color: "#FFC107",
        ...
        desc: "Event organizers and bookers. Find artists touring near your city, share costs for touring talent, discover the right venue for your event, and manage bookings from offer to payment."
    },
    {
        title: "Venues",
        color: "#F5576C",
        ...
        desc: "Clubs, festivals, and event spaces. Connect with international artists touring your city, discover local scene talent and promoters, and fill your calendar with quality events."
    },
    {
        title: "Agents",
        color: "#43E97B",
        ...
        desc: "Artist managers and booking agents. Manage your roster, handle bookings, contracts, and payments for your artists — the full process in one seamless platform."
    }
];
                    ...
                    {roles.map((item) => (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-xs font-bold uppercase tracking-widest" style={{ color: item.color, fontFamily: 'var(--font-space-grotesk), sans-serif' }}>{item.title}</span>
                            </div>
